...
Terraform will perform the following actions:
  ...
  ~ resource "azurerm_firewall_application_rule_collection" "ApplicationRules" {
        id                  = "/subscriptions/xxxxxxxf-8244-467c-bxxx-xxxxxxxxxxxxx/resourceGroups/xxxx-0000-dev-eastus-rg-network/providers/Microsoft.Network/azureFirewalls/xxxx0000-dev-eastus-fw-hub/applicationRuleCollections/ApplicationRules"
  ...
  ~ resource "azurerm_firewall_application_rule_collection" "Databricks_allow" {
        id                  = "/subscriptions/xxxxxxxf-8244-467c-b9xx-xxxxxxxxxxxxxx/resourceGroups/xxxx-0000-dev-eastus-rg-network/providers/Microsoft.Network/azureFirewalls/xxxx-0000-dev-eastus-fw-hub/applicationRuleCollections/Databricks_Allow"
  ...
  ~ resource "azurerm_monitor_diagnostic_setting" "fw-hub-NetworkRule" {
        id                             = "/subscriptions/xxxxxxxf-8244-467c-b9xx-xxxxxxxxx/resourceGroups/xxxx-0000-dev-eastus-rg-network/providers/Microsoft.Network/azureFirewalls/xxxx-0000-dev-eastus-fw-hub|sendToALA"
      + log_analytics_destination_type = "Dedicated"
      ~ log_analytics_workspace_id     = "/subscriptions/xxxxxxxf-8244-467c-b933-xxxxxxxx/resourceGroups/xxxx-xx13-dev-eastus-rg-datalake/providers/Microsoft.OperationalInsights/workspaces/sentinel-log-analytics-workspace-xxxx-dev" -> "/subscriptions/xxxxxxxf-8244-467c-b933-4a2ae3a5964e/resourceGroups/xxxx-xx13-dev-eastus-rg-datalake/providers/Microsoft.OperationalInsights/workspaces/sentinel-log-analytics-workspace-XXXX-dev"
        name                           = "sendToALA"
      ...
      - log {
          - category = "AZFWNatRuleAggreg" -> null
          - enabled  = false -> null
      ...
      - log {
          - category = "AZFWNetworkRuleAggreg" -> null
          - enabled  = false -> null
